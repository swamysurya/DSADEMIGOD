...
export default function LinearProbingSimulation() {
  ...
  const steps: SimulationStep[] = [
    {
      activeKey: null,
      formula: null,
      explanation: "We begin with a fresh, empty array of capacity 10. We will insert 10 elements: 15, 25, 35, 45, 55, 18, 28, 38, 48, and 58 sequentially. Note how Linear Probing's step-by-step sequential search (i = +1, +2...) starts to build up consecutive blocks.",
    ...
    },
    {
      ...
      explanation: "Key 25 hashes to index 5. Since index 5 is occupied, we check the next sequential index: slot [6]. Slot [6] is empty, so 25 is stored there.",
    ...
    },
    {
      ...
      explanation: "Key 35 hashes to index 5. We probe slot [5] and slot [6] (both occupied) before finding that slot [7] is empty. 35 is stored at index 7.",
      arrayState: [null, null, null, null, null, 15, 25, 35, null, null],
      probedIndexes: [5, 6, 7]
    },
    {
      activeKey: 45,
      formula: "45 % 10 = 5 (Collision!)",
      explanation: "Key 45 hashes to index 5. We probe slots [5], [6], and [7] sequentially, and store 45 in the next empty slot: index 8.",
      arrayState: [null, null, null, null, null, 15, 25, 35, 45, null],
      probedIndexes: [5, 6, 7, 8]
    },
    {
      activeKey: 55,
      formula: "55 % 10 = 5 (Collision!)",
      explanation: "Key 55 hashes to index 5. Probing checks [5], [6], [7], [8], and lands in the first empty slot: index 9.",
      arrayState: [null, null, null, null, null, 15, 25, 35, 45, 55],
      probedIndexes: [5, 6, 7, 8, 9]
    },
    {
      activeKey: 18,
      formula: "18 % 10 = 8 (Collision!)",
      explanation: "Key 18 hashes to index 8. Slot [8] is occupied by 45, and slot [9] is occupied by 55. We wrap around to slot [0] which is empty, storing 18 there.",
      arrayState: [18, null, null, null, null, 15, 25, 35, 45, 55],
      probedIndexes: [8, 9, 0]
    },
    {
      activeKey: 28,
      formula: "28 % 10 = 8 (Collision!)",
      explanation: "Key 28 hashes to index 8. Probing sequentially scans [8], [9], [0] (occupied), and finally stores 28 in slot [1].",
      arrayState: [18, 28, null, null, null, 15, 25, 35, 45, 55],
      probedIndexes: [8, 9, 0, 1]
    },
    {
      activeKey: 38,
      formula: "38 % 10 = 8 (Collision!)",
      explanation: "Key 38 hashes to index 8. It sequentially scans [8], [9], [0], [1] before finding the first empty slot at index 2.",
      arrayState: [18, 28, 38, null, null, 15, 25, 35, 45, 55],
      probedIndexes: [8, 9, 0, 1, 2]
    },
    {
      activeKey: 48,
      formula: "48 % 10 = 8 (Collision!)",
      explanation: "Key 48 hashes to index 8. It scans [8] through [2] sequentially, and stores at slot [3].",
      arrayState: [18, 28, 38, 48, null, 15, 25, 35, 45, 55],
      probedIndexes: [8, 9, 0, 1, 2, 3]
    },
    {
      activeKey: 58,
      formula: "58 % 10 = 8 (Collision!)",
      explanation: "Key 58 hashes to index 8. It scans [8] through [3] sequentially (taking 7 probing steps!) and stores at slot [4]. Notice how a single consecutive block (Primary Cluster) now fills the entire table, making insertions very slow.",
      arrayState: [18, 28, 38, 48, 58, 15, 25, 35, 45, 55],
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-[#DDD7CC]/50 pb-3">
        <div>
          ...
          <p className="text-xs text-[#666666]" style={{ fontFamily: "'Caveat', cursive", fontSize: "14px" }}>
            "Step-by-step visual of Primary Clustering."
          </p>
        </div>
